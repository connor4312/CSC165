    ...
    \item Assume $x \in \mathbb{R}$ \# generic
        ...
        \item Assume $y \in \mathbb{R}$ \# generic
            ...
            \item Assume $x > y$ \# Antecedent
                ...
                \item Then $\exists d \in \mathbb{N}_0, d = x - y$ \# $x > y$ in the antecedent.
                ...
                \item Then $\floor{x} \leq \floor{y}$ \# $z \leq z + d$
                \end{description}
...
\item Proving the statement 1.3 true. %1.3
    \begin{description}
    \item Let $x = 0.5$
    \item Then $x \in \mathbb{R}$ \# 0.5 is a positive real number
    \item Assume $e \in \mathbb{R}^+$ \# Generic
        ...
        \item Assume $w \in \mathbb{R}$ and that $\mid x - w \mid < d$
            \begin{description}
            \item Then $0.4 < w < 0.6$ \# Difference between x (0.5) and w is less than 0.1, by the antecedent.
            \item Then $\floor{w} = 0$ and $\floor{x} = 0$ \# From definition of floor
            \item Then $\mid \floor{x} - \floor{w} \mid = 0$ \# Zero minus zero is simply zero.
            \item Then $\mid \floor{x} - \floor{w} \mid < e$ \# Zero is less than all positive real numbers, by the definition of positive.
            \end{description}
...
\item Proving 1.4 False. %1.4
		...
		\item $\forall x \in \mathbb{R} \floor{x+1} = \floor{x} + 1$
				...
				\item Assume $x \in \mathbb{R}$ \# Generic
						\begin{description}
						\item $\exists Z_{0}, Z_1$ such that $Z_0 \leq x+1 \wedge \forall Z_0 \in \mathbb{Z}, Z_0 \leq x+1 \Rightarrow Z_0 \leq \floor{x+1}$, $Z_1 \leq x \wedge \forall Z_1 \in \mathbb{Z}, Z_1 \leq x \Rightarrow Z_1 \leq \floor{x}$
...
\item Proving 2.1 is true, and proving the converse of 2.1 is false.
		\begin {description}
				...
				\begin{description}
						...
						\item Then $j_0 = 5k_0^2 + 4k_0$ \# $j_0 \in \mathbb{N}$, since natural numbers closed under addition, multiplication, and exponentiation.
						\item Then $\exists j \in \mathbb{N}$ such that $n^2 = 5j+4$ \# $j_0$ is such a number.
				\end {description}
