...
\item Proving 1.4 False. %1.4
		...
		\item $\forall x \in \mathbb{R} \floor{x+1} = \floor{x} + 1$
				...
				\item Assume $x \in \mathbb{R}$ \# Generic
						\begin{description}
						\item $\exists Z_{0}, Z_1$ such that $Z_0 \leq x+1 \wedge \forall Z_0 \in \mathbb{Z} Z_0 \leq x+1 \Rightarrow Z_0 \leq \floor{x+1}$ \# Definition of floor.
						\item $\exists Z_1, Z_1$ such that $Z_1 \leq x \wedge \forall Z_1 \in \mathbb{Z}, Z_1 \leq x \Rightarrow Z_1 \leq \floor{x}$ \# Definition of floor.
