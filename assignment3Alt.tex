...
\end {description}
\item Proving number 5 to be False.
We prove negation of cases with $\mathcal{O}(g)$ and $\Omega(g)$ respectively
\begin{description}
	\item Defininition of $\mathcal{O}(g):\\ \exists c \in \mathbb{R}^+, \exists B \in \mathbb{N}, \forall n \in n, n \geq B \implies f(n) \leq cg(n)$\
	\item Defininition of $\lnot(\mathcal{O}(g)):\\ \forall c \in \mathbb{R}^+, \forall B \in \mathbb{N}, \exists n \in \mathbb{N}, n \geq B \implies f(n) > cg(n)$\
	\item Defininition of $\Omega(g):\\ \exists c \in \mathbb{R}^+, \exists B \in \mathbb{N}, \forall n \in \mathbb{N}, n \geq B \implies f(n) \geq cg(n)$\
	\item Defininition of $\lnot\Omega(g):\\ \forall c \in \mathbb{R}^+, \forall B \in \mathbb{N}, \exists  n \in\mathbb{N}, n \geq B \implies f(n) < cg(n)$
\begin{equation*}
f(n) = \begin{cases}
             6  & \text{if } n = 2k + 1(k \in \mathbb{N}) \# Odd \\
             0  & \text{if } n = 2k(k \in \mathbb{N}) \# Even
       \end{cases} \quad
g(n) = \begin{cases}
             0  & \text{if } n = 2k + 1(k \in \mathbb{N}) \# Odd \\
             6  & \text{if } n = 2k(k \in \mathbb{N}) \# Even
       \end{cases}
\end{equation*}
\item Proving $\lnot \mathcal{O}(g):$
			...
			\begin{description}
				...
				\begin{description}
					...
					\begin{description}
						...
						\item Pick n = m + 1
						\item Then n odd 
						\item $f(n) > g(n)$ \# g(n) = 0 when n odd and f(n) = 6 when n odd. Therefore $6 > 0$
					\end {description}
					\item Case 2:
					\begin{description}
